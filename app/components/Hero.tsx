...
const Hero = () => {
  ...
  return (
    <section className='pt-20'>
        ...
        <div className='w-[80%] h-[50vh] md:h-[60vh] lg:h-[80vh] border-[5px] border-[#3BD6FF] border-opacity-70 mx-auto rounded-2xl overflow-hidden mt-20 bg-[url("/car.jpg")] bg-no-repeat bg-cover'>
